package com.tugasakhir.shotbook.photography.home.view
 ...
 */
class PhotographerHomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as PhotographerMainActivity).supportActionBar?.title = "Home"
